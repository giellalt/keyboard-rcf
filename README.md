.. -*- mode: rst -*-
==========================================
 Keyboards for the Réunion Creole French language
==========================================

This directory contains source files and build instructions for developing
keyboards for the Réunion Creole French language. The data and implementations
...
The Réunion Creole French keyboard sources can be acquired using the `Giella SVN
